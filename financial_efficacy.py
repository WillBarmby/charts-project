    ...
    for subject in subjects:
        for span in grade_spans:
            make_swarm_plot(
                ...
                output_path=f"/Users/willbarmby/Python-Projects/charts/graphs/fe/Financial Efficacy of {subject} - {span}.png",
                figsize=(8, 4),
                ylim=(-0.5, 1.5),
                dot_size=5,
        ...
        make_swarm_plot(
            ...
            xlabel="Cost per Successful Student Outcome (USD)",
            output_path=f"/Users/willbarmby/Python-Projects/charts/graphs/fe/Financial Efficacy of {subject} total.png",
            figsize=(8, 4),
            ylim=(-0.5, 1.5),
            dot_size=2,
            format_as_percent=False
