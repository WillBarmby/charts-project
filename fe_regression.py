...
make_swarm_plot(
        ...
        output_path=f"/Users/willbarmby/Python-Projects/charts/graphs/financial_efficacy/linear/ELA - Residuals Overall.png",
        figsize=(8,4),
        ylim=(-.5,1.5),
        xlim=(-3.05, 3.05),
        dot_size=3,
...
make_swarm_plot(
        ...
        # filter_column={"Assessment": subject},
        xlabel="Residual Scale",
        output_path=f"/Users/willbarmby/Python-Projects/charts/graphs/financial_efficacy/linear/Science - Residuals Overall.png",
        figsize=(8,4),
        ylim=(-.5,1.5),
        xlim=(-3.05, 3.05),
        dot_size=3,
...
make_swarm_plot(
        ...
        # filter_column={"Assessment": subject},
        xlabel="Residual Scale",
        output_path="/Users/willbarmby/Python-Projects/charts/graphs/financial_efficacy/linear/Math - Residuals Overall.png",
        figsize=(8,4),
        ylim=(-.5,1.5),
        xlim=(-3.05, 3.05),
        dot_size=3,
